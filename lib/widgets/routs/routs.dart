...
import '../../screen/full_screen_video_play.dart';
...
final GoRouter router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: RoutsName.fullVideoScreen,
      builder: (context, state) {
        final url = state.uri.queryParameters['url'] ?? '';
        return FullScreenVideoPlayer(url: url);
      },
    ),
    ...
    GoRoute(
      path: RoutsName.reelsVideoPlayer,
      builder: (context, state) {
        final videoUrl = state.uri.queryParameters['videoUrl'] ?? '';
        return ReelsStyleVideoPlayer(videoUrl: videoUrl);
      },
    ),
    ...
    GoRoute(
      path: RoutsName.fullImageScreen,
      builder: (context, state) {
    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        if (driver == null) {
          return Scaffold(body: Center(child: Text("Driver data is missing.")));
        }
...
class RoutsName {
  ...
  static String fullImageScreen = '/fullImageScreen';
  static String reelsVideoPlayer = '/reelsVideoPlayer';
}
